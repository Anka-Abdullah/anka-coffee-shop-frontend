        ...
        <b-row>
          <b-col lg="6" sm="12">
            ...
            <form>
              ...
              <b-row>
                <select name="starthour" id="starthour" class="mx-auto">
              ...
              <div class="my-3"></div>
              <b-row>
                <select name="endhour" id="endhour" class="mx-auto">
                  <option>Select start hour</option>
                  <option value="10">10:00</option>
                  <option value="11">11:00</option>
                  <option value="12">12:00</option>
              ...
              <h4 class="anka-title mt-5 mb-3 text-center">Input Stock :</h4>
              <b-row>
                <input type="number" class="stock mx-auto mb-5" />
              </b-row>
            </form>
            <hr class="responsive" />
          </b-col>
